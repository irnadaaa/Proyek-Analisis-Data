...
if selected == 'Kinerja Setahun Terakhir':
    ...
    st.pyplot(plt)
    st.markdown(f"Berdasarkan grafik di atas dapat diketahui kinerja selama setahun terakhir mengalami kenaikan dari pada setahun sebelumnya. Berikutnya akan dianalisis mengenai kinerja rental bulanan hingga per jam pada setahun terakhir.")
